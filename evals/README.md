...
For the v0.8.20 candidate, the 73-case combined routing corpus, eight bounded
...
and earlier evidence remains distinct; no current v0.8.20 host result is
inferred from it.
...
unpublished evidence; neither is promoted or reused for v0.8.20. The immutable
v0.8.19 Release and its acceptance also remain separate history.
