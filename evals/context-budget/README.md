...
The immutable v0.7.9 gate is the cumulative baseline for v0.7.10:

| Metric | Baseline | v0.7.10 candidate | Classification |
| --- | ---: | ---: | --- |
...
The v0.7.10 record represents all required paths: fresh startup with a no-route
...
v0.7.10 is `NOT-RUN`; authenticated Claude Code observation is
`UNAVAILABLE / NOT-RUN`.
...
versioned record is [v0.7.10](results/v0.7.10.json).
