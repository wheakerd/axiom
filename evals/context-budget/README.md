...
The immutable v0.7.9 gate is the cumulative baseline for the v0.8.7 candidate:

| Metric | Baseline | v0.8.7 candidate | Delta | Classification |
| --- | ---: | ---: | ---: | --- |
...
The v0.8.7 record represents all required paths: fresh startup with a no-route
...
v0.8.7 is `NOT-RUN`; authenticated Claude Code observation is
...
are not copied into the v0.8.7 candidate's host metrics. Current exact host
...
versioned record is [v0.8.7](results/v0.8.7.json). The v0.8.6 record remains
