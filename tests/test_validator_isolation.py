...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 83 required files, 6 JSON files, "
    "103 Markdown files, 68 offline route contract fixtures, "
    ...
    "14 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
    ...
    "54 release-provenance fixtures, 10 immutable external action and image pins, "
