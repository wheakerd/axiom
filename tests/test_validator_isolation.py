...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 82 required files, 6 JSON files, "
    "102 Markdown files, 68 offline route contract fixtures, "
    ...
    "13 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
