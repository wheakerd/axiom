...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 79 required files, 6 JSON files, "
    "99 Markdown files, 68 offline route contract fixtures, "
    ...
    "10 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
