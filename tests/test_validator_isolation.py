...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 84 required files, 6 JSON files, "
    "104 Markdown files, 68 offline route contract fixtures, "
    ...
    "15 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
