...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 81 required files, 6 JSON files, "
    "101 Markdown files, 68 offline route contract fixtures, "
    ...
    "12 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
    ...
    "21 release-provenance fixtures, 10 immutable external action and image pins, "
