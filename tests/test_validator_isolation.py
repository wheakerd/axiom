...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 123 required files, 3 JSON files, "
    "123 Markdown files, 17 documentation negative fixtures, "
    ...
    "20 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
