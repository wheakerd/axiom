...
EXPECTED_SUCCESS_SUMMARY = (
    "Publication validation passed: 80 required files, 6 JSON files, "
    "100 Markdown files, 68 offline route contract fixtures, "
    ...
    "11 canonical release-fact surfaces, 10 structured Git route-boundary scenarios, "
