...
def _schema_contract(schema: dict[str, Any]) -> dict[str, Any]:
    ...
    if (
        ...
        or (source_revision, candidate_revision) not in {(5, 6), (8, 9), (11, 12), (13, 14), (24, 25), (27, 28)}
    ):
    ...
    if source_revision in {8, 11, 13, 24, 27}:
    ...
    if source_revision in {8, 11, 13, 24, 27} and (
