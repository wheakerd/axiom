...
EXPECTED_CODEX_INTERFACE = {
    ...
    "longDescription": (
        "Axiom routes focused workflows for intent clarification, simple-task delegation, task planning, repository instructions, plugin architecture, usage optimization, "
